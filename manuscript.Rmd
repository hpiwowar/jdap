...
Even when there are journal policies, often not sufficient to achieve reproducability for the majority of studies `r citep(c(bib["roche2015public"], bib["stodden2018an-empi"], bib["naudet2018data-sh"]))`


suggesting author personality `r citep(c(bib["linek2017data-sh"]))` or social norms `r citep(c(bib["anagnostou2015when-da"], bib["womack2015researc"]))` may play a larger factor than journal policy.

Findings here are consistent with other findings that authors more likely to share data if they had prior experience sharing or reusing data
`r citep(c(bib["Piwowar_2011"]))`.
...
Similarily, although of course data archiving has a cost, it also has a good return on investment in terms of research output `r citep(c(bib["piwowar2011data-ar"]))`. 
...
cite this? `r citep(c(bib["van-tuyl2016water-w"]))`. 
also maybe this?  `r citep(c(bib["fetterman2015the-rep"]))`. 


still pulling these in to discussion notes `r citep(c(bib["budin-ljosne2014data-sh"],bib["lin2014recomme"],bib["roche2014trouble"],bib["vines2013mandate"],bib["pearce2011data-sh"],bib["alsheikh-ali2011public"]))`
