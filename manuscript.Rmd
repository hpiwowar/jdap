...
tmp$variable <- gsub("Q_", "Question ", tmp$variable)
p <- plot_likert(tmp, response='value', var_x='label_PolicyAdoptedAtPublication_space', var_facet="variable", response_order=responses_agree_disagree, above_mid="Somewhat Agree", na.label="No response", xlab="% Responses", ylab="JDAP Policy")
...
p <- plot_likert(tmp, response='value', var_x='label_PolicyAdoptedAtPublication_space', var_facet="variable", response_order=responses, above_mid="Strongly Agree", na.label="No response", xlab="% Responses", ylab="JDAP Policy", include.N=FALSE)
p <- p + theme(axis.text.x=element_text(angle=-90, size=8))
