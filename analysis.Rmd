...
tmp <- melt(d, measure.vars=c('Q_1','Q_2','Q_9'))
tmp$variable <- gsub("Q_", "Question ", tmp$variable)
...
responses <- c("5+ papers","2-4 papers","1 paper","None") # response categories from top to bottom
tmp <- melt(d, measure.vars=c('Q_3'))
tmp$variable <- gsub("Q_", "Question ", tmp$variable)
p <- plot_likert(tmp, response='value', var_x='label_PolicyAdoptedAtPublication', var_facet="variable", response_order=responses, above_mid="None", na.label="No response", xlab="% Responses", ylab="JDAP Policy")
...
unique( d$Q_4_17 )
unique(as.character(d$Q_4_3))
1:15
responses <- c( "Many times","A few times","Once","Never") # response categories from top to bottom

tmp <- melt(d, measure.vars=paste0('Q_4_',c(1:15,17) ))
tmp$variable <- gsub("Q_", "Question ", tmp$variable)
p <- plot_likert(tmp, response='value', var_x='label_PolicyAdoptedAtPublication', var_facet="variable", response_order=responses, above_mid="Never", na.label="No response", xlab="% Responses", ylab="JDAP Policy", include.N=FALSE)
...
with(d, xtabs(~I(Q_6_1!="")+I(Q_6_2!="")+I(Q_6_3!="") ))
